...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\USER\PycharmProjects\AverageCgpaCalculator\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\USER\PycharmProjects\AverageCgpaCalculator\venv\Scripts\deactivate.nu'
